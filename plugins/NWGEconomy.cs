...
{
    [Info("NWGEconomy", "New World Gaming", "1.0.0")]
    [Description("Core economy system and API for NWG server")]
    public class NWGEconomy : CovalencePlugin
    {
        ...
        protected override void LoadDefaultMessages()
        {
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                ["CommandWipe"] = "ecowipe",
                ["DataSaved"] = "Economy data saved!",
                ["DataWiped"] = "Economy data wiped!",
                ...
                ["TransferToSelf"] = "You can not transfer money to yourself!",
                ...
                ["UsageWipe"] = "Usage: {0} - wipe all economy data",
        ...
        private const string permissionBalance = "nwgeconomy.balance";
        private const string permissionDeposit = "nwgeconomy.deposit";
        private const string permissionDepositAll = "nwgeconomy.depositall";
        private const string permissionSetBalance = "nwgeconomy.setbalance";
        private const string permissionSetBalanceAll = "nwgeconomy.setbalanceall";
        private const string permissionTransfer = "nwgeconomy.transfer";
        private const string permissionTransferAll = "nwgeconomy.transferall";
        private const string permissionWithdraw = "nwgeconomy.withdraw";
        private const string permissionWithdrawAll = "nwgeconomy.withdrawall";
        private const string permissionWipe = "nwgeconomy.wipe";
        ...
        private void CommandTransfer(IPlayer player, string command, string[] args)
        {
            ...
            if (args[0] == "*")
            {
                ...
                Message(player, "TransferredToAll", amount, splitAmount, receivers);
            }
            else
            {
                IPlayer target = FindPlayer(args[0], player);
...
namespace Oxide.Plugins.NWGEconomyExtensionMethods
{
