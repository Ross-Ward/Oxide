...
using static Oxide.Plugins.NWGHealth;
using System.Text;
...
using System.Linq;
using Oxide.Plugins.NWGHealthExtensionMethods;
using Oxide.Core.Libraries.Covalence;

namespace Oxide.Plugins
{
    [Info("NWGHealth", "New World Gaming", "1.0.0")]
    [Description("Players can sustain injuries and become infected with diseases.")]
    public partial class NWGHealth : CovalencePlugin
    {
        // Changelog
        /*
            ### 1.3.0
        ...
        public static NWGHealth PLUGIN;
        ...
        private const string PermissionDoctor = "nwghealth.doctor";
        private const string PermissionAdmin = "nwghealth.admin";
        ...
        void SaveAll()
        {
            SaveDataFile("NWGHealth_Conditions", Data);
        }

        void LoadAll()
        {
            Data = LoadDataFile<SaveData>("NWGHealth_Conditions") ?? new SaveData();
        }
...
namespace Oxide.Plugins
{
    partial class NWGHealth : CovalencePlugin
    {
        /*
...
namespace Oxide.Plugins
{
    public partial class NWGHealth
    {
...
namespace Oxide.Plugins.NWGHealthExtensionMethods
{
...
namespace Oxide.Plugins
{
    public partial class NWGHealth
    {
        ...
        Dictionary<ulong, NWGHealth.ZombieLootInfo> EntityIdToItemList = new Dictionary<ulong, NWGHealth.ZombieLootInfo>();
        ...
        void OnPlayerCorpseSpawned(BasePlayer basePlayer, PlayerCorpse corpse)
        {
            ...
            timer.In(PremadeStatusConditions.Z13Virus.Config.ReanimationSeconds.Value, () =>
            {
                ...
                entity.Spawn();
                EntityIdToItemList[entity.userID] = new NWGHealth.ZombieLootInfo(basePlayer);
...
namespace Oxide.Plugins
{
    partial class NWGHealth : CovalencePlugin
    {
        public static class PremadeStatusConditions
        {
            ...
            public static readonly Dictionary<string, NWGHealth.StatusConditionConfig> DefaultConfigs = new Dictionary<string, NWGHealth.StatusConditionConfig>()
            {
                [Concussion.Id] = new NWGHealth.StatusConditionConfig
                {
                    Enabled = true,
                ...
                [FoodPoisoning.Id] = new NWGHealth.StatusConditionConfig
                {
                    Enabled = true,
                ...
                [Z13Virus.Id] = new NWGHealth.StatusConditionConfig
                {
                    Enabled = true,
                ...
                [Rabies.Id] = new NWGHealth.StatusConditionConfig
                {
                    Enabled = true,
                ...
                [BrokenLeg.Id] = new NWGHealth.StatusConditionConfig
                {
                    Enabled = true,
                ...
                [Tapeworm.Id] = new NWGHealth.StatusConditionConfig
                {
                    Enabled = true,
...
namespace Oxide.Plugins
{
    public partial class NWGHealth : CovalencePlugin
    {
        public static class Statuses
        {
            ...
            {
                return PLUGIN != null && PLUGIN.SimpleStatus != null && PLUGIN.SimpleStatus.IsLoaded;
            }
    ...
    partial class NWGHealth : CovalencePlugin
    {
        public class StatusCondition
        {
            ...
            public string Icon
            {
                get
                {
                    return CustomIcon ?? $"nwg.health.icon.{Id}";
                }
            }
