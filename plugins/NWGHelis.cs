...
namespace Oxide.Plugins
{
    ...
    class NWGHelis : RustPlugin
    {
        ...
        private const string CustomHelicopterTiersAdmin = "nwghelis.admin";

        public static string GetTierSpawnPermissionName(string tierName) =>
            "nwghelis.call." + tierName.ToLower();

        public static string GetLimitPermissionName(string limitName) =>
            "nwghelis.limits." + limitName.ToLower();
        ...
        private static NWGHelis _instance;
        public const string MainFolderName = "NWGHelis";
        ...
        void SaveTrackers() => Interface.Oxide.DataFileSystem.WriteObject("NWGHelis", CommandTracker);
        ...
        public static class Commands
        {
            ...
            /// heli.help
            /// </summary>
            public const string Help = "helis.help";
            ...
            /// heli.call <Tier> <SteamID>
            /// </summary>
            public const string Call = "helis.call";

            /// <summary>
            /// heli.kill <Tier>
            /// heli.kill all
            /// </summary>
            public const string Kill = "helis.kill";

            /// <summary>
            /// heli.loot set <Tier>
            /// </summary>
            public const string Loot = "helis.loot";
            ...
            /// heli.spawn show
            /// </summary>
            public const string Spawn = "helis.spawn";

            /// <summary>
            /// heli.delete <Tier>
            /// </summary>
            public const string Delete = "helis.delete";

            /// <summary>
            /// heli.add <Tier>
            /// </summary>
            public const string Add = "helis.add";

            /// <summary>
            /// heli.list
            /// </summary>
            public const string List = "helis.list";

            /// <summary>
            /// heli.report
            /// </summary>
            public const string Report = "helis.report";
        }
