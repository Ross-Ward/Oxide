...
using PluginComponents.NWGWeed;
using PluginComponents.NWGWeed.Core;
using PluginComponents.NWGWeed.Extensions.Command;
using System;
...
{
    [Info(nameof(NWGWeed), "The_Kiiiing", "2.0.11")]
    public class NWGWeed : BasePlugin<NWGWeed, NWGWeed.Configuration>
    {
        #region Fields
        ...
        [Perm]
        private const string PERM_GATHER = "nwgweed.gather";
        [Perm]
        private const string PERM_CRAFT = "nwgweed.craft";
        [Perm]
        private const string PERM_GIVE = "nwgweed.give";
        
        private const string CMD_TOGGLE_UI = "nwgweed.toggleui";
        private const string CMD_CRAFT = "nwgweed.craft";
        ...
        public class CustomRecipe
        {
            ...
            [JsonProperty("Identifier (used with NWGWeed.give command)")]
        ...
        public class WeedConfig : CustomItem
        {
            ...
            [JsonProperty("Item identifier (used with NWGWeed.give command)")]
            public string identifier = String.Empty;
        ...
        {
            public const string LAYER_RECIPE = "NWGWeed.ui.craft";
            public const string LAYER_TOGGLE = "NWGWeed.ui.toggle";
            public const string LAYER_CRAFT_BUTTON = "NWGWeed.ui.craftbutton";

            public const string LAYER_BLUR = "NWGWeed.ui.effects.blur";
            public const string LAYER_COLOR = "NWGWeed.ui.effects.color";
        ...
        [UniversalCommand("NWGWeed.give", Permission = PERM_GIVE)]
