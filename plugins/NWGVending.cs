...
{
    [Info("NWGVending", "NWG Team", "2.15.1")]
    [Description("Allows editing orders at NPC vending machines.")]
    internal class NWGVending : CovalencePlugin
    {
#region Fields

        [PluginReference]
        private readonly Plugin BagOfHolding, Economics, ItemRetriever, NWGMonumentFinder, NWGMarket, ServerRewards;
        ...
        private const string PermissionUse = "nwgvending.use";
...
#region Hooks
        ...
        private void OnServerInitialized()
        {
            ...
            if (NWGMonumentFinder == null)
            {
                LogWarning("NWGMonumentFinder is not loaded, so you won't be able to save vending machine customizations relative to monuments.");
            }
        ...
        private void OnPluginLoaded(Plugin plugin)
        {
            switch (plugin.Name)
            {
                case nameof(NWGMonumentFinder):
                {
                    ...
                    {
                        // Delay to ensure NWGMonumentFinder's `OnServerInitialized` method is called.
        ...
        private void OnVendingShopOpened(NPCVendingMachine vendingMachine, BasePlayer player)
        {
            ...
            if ((_config.Economics.EnabledAndValid && profile.HasPaymentProviderCurrency(_config.Economics))
                ...
                || (_config.NWGMarket.EnabledAndValid && profile.HasPaymentProviderCurrency(_config.NWGMarket)))
            {
        ...
        private object OnVendingTransaction(NPCVendingMachine vendingMachine, BasePlayer player, int sellOrderIndex, int numberOfTransactions, ItemContainer targetContainer)
        {
            ...
            {
                ExposedHooks.OnNWGVendingTransactionWithCustomSettings(vendingMachine, offer.CustomSettings);
            }
        ...
        private object OnNpcGiveSoldItem(NPCVendingMachine vendingMachine, Item item, BasePlayer player)
        {
            ...
            ExposedHooks.OnNWGVendingGiveSoldItem(vendingMachine, item, player);
...
#region Dependencies
        ...
        {
            private NWGVending _plugin;
            private Plugin _monumentFinder => _plugin.NWGMonumentFinder;

            public MonumentFinderAdapter(NWGVending plugin)
            {
                _plugin = plugin;
            }
        ...
        private class BagOfHoldingLimitManager
        {
            ...
            public BagOfHoldingLimitManager(NWGVending plugin)
            {
                _plugin = plugin;
            }
        ...
        private class ItemRetrieverAdapter
        {
            ...
            public ItemRetrieverAdapter(NWGVending plugin)
            {
                _plugin = plugin;
            }
...
#region Exposed Hooks
        ...
        {
            public static object OnNWGVending(NPCVendingMachine vendingMachine)
            {
                return Interface.CallHook("OnNWGVending", vendingMachine);
            }
            ...
            public static Dictionary<string, object> OnNWGVendingDataProvider(NPCVendingMachine vendingMachine)
            {
                return Interface.CallHook("OnNWGVendingDataProvider", vendingMachine) as Dictionary<string, object>;
            }

            public static void OnNWGVendingOfferSettingsParse(CaseInsensitiveDictionary<string> localizedSettings, CaseInsensitiveDictionary<object> customSettings)
            {
                Interface.CallHook("OnNWGVendingOfferSettingsParse", localizedSettings, customSettings);
            }

            public static void OnNWGVendingOfferSettingsDisplay(CaseInsensitiveDictionary<object> customSettings, CaseInsensitiveDictionary<string> localizedSettings)
            {
                Interface.CallHook("OnNWGVendingOfferSettingsDisplay", customSettings, localizedSettings);
            }

            public static void OnNWGVendingTransactionWithCustomSettings(NPCVendingMachine vendingMachine, CaseInsensitiveDictionary<object> customSettings)
            {
                Interface.CallHook("OnNWGVendingTransactionWithCustomSettings", vendingMachine, customSettings);
            }

            public static void OnNWGVendingGiveSoldItem(NPCVendingMachine vendingMachine, Item item, BasePlayer player)
            {
                Interface.CallHook("OnNWGVendingGiveSoldItem", vendingMachine, item, player);
            }
        }
...
#region Helper Methods
        ...
        public static void LogInfo(string message) => Interface.Oxide.LogInfo($"[NWGVending] {message}");
        public static void LogError(string message) => Interface.Oxide.LogError($"[NWGVending] {message}");
        public static void LogWarning(string message) => Interface.Oxide.LogWarning($"[NWGVending] {message}");
        ...
        private static VendingOffer[] GetOffersFromContainer(NWGVending plugin, BasePlayer player, ItemContainer container)
        {
        ...
        private static StorageContainer CreateOrdersContainer(NWGVending plugin, NPCVendingMachine vendingMachine, BasePlayer player, VendingOffer[] vendingOffers)
        {
            ...
            for (var orderIndex = 0; orderIndex < 7; orderIndex++)
            {
                ...
                ExposedHooks.OnNWGVendingOfferSettingsDisplay(
        ...
        private void AddCurrencyToContainerSnapshot(BasePlayer player, ProtoBuf.ItemContainer containerData)
        {
            ...
            if (_config.NWGMarket.EnabledAndValid && profile.HasPaymentProviderCurrency(_config.NWGMarket))
            {
                AddItemForNetwork(
                    containerData,
                    slot: nextInvisibleSlot,
                    itemId: _config.NWGMarket.ItemDefinition.itemid,
                    amount: _paymentProviderResolver.NWGMarketPaymentProvider.GetBalance(player),
                    uid: new ItemId(ulong.MaxValue - (ulong)nextInvisibleSlot)
                );
                nextInvisibleSlot++;
            }
...
#region UI
        ...
        private static class UIConstants
        {
            ...
            public const string EditButtonColor = "0.718 0.816 0.573 1";   // Sage Green #b7d092
            public const string EditButtonTextColor = "0.15 0.15 0.15 1";  // Dark Text for contrast on light button

            public const string ResetButtonColor = "1 0.647 0 1";          // Orange #FFA500
            public const string ResetButtonTextColor = "0.15 0.15 0.15 1"; // Dark Text

            public const string SaveButtonColor = EditButtonColor;
            public const string SaveButtonTextColor = EditButtonTextColor;

            public const string CancelButtonColor = "0.851 0.325 0.31 1";  // Red/Rust #d9534f
            public const string CancelButtonTextColor = "0.9 0.9 0.9 1";   // Light Text
        ...
        {
            public const string UIName = "NWGVending.ContainerUI";

            public const string TipUIName = "NWGVending.ContainerUI.Tip";
            public const string BroadcastUIName = "NWGVending.ContainerUI.Broadcast";
            public const string DroneUIName = "NWGVending.ContainerUI.Drone";

            public static string RenderContainerUI(NWGVending plugin, BasePlayer player, NPCVendingMachine vendingMachine, VendingController controller, EditFormState uiState)
            {
                var offsetX = 192;
                var offsetY = 142.5f;
            ...
            private static void AddBroadcastButton(CuiElementContainer cuiElements, NPCVendingMachine vendingMachine, EditFormState uiState)
            {
                ...
                cuiElements.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        ...
                        {
                            Color = "0 0 0 0",
                            Command = $"nwgvending.ui {vendingMachine.net.ID} {UICommands.ToggleBroadcast}",
                        },
                        new CuiRectTransformComponent
                        {
                            AnchorMin = "0 0",
            ...
            private static void AddDroneButton(CuiElementContainer cuiElements, NPCVendingMachine vendingMachine, EditFormState uiState)
            {
                ...
                cuiElements.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        ...
                        {
                            Color = "0 0 0 0",
                            Command = $"nwgvending.ui {vendingMachine.net.ID} {UICommands.ToggleDroneAccessible}",
                        },
                        new CuiRectTransformComponent
                        {
                            AnchorMin = "0 0",
                ...
                cuiElements.Add(
                    new CuiButton
                    {
                        ...
                        Button =
                        {
                            Color = color,
                            FadeIn = 0.1f,
                            Command = $"nwgvending.ui {vendingMachineId} {subCommand}",
                        },
                        RectTransform =
                        {
                            AnchorMin = "0 0",
        ...
        {
            public const string UIName = "NWGVending.AdminUI";

            public static string RenderAdminUI(NWGVending plugin, BasePlayer player, NPCVendingMachine vendingMachine, VendingProfile profile)
            {
        ...
        {
            public const string UIName = "NWGVending.ShopUI";
...
#region Payment Providers
        ...
        private class ItemsPaymentProvider : IPaymentProvider
        {
            ...
            public ItemsPaymentProvider(NWGVending plugin)
            {
                _plugin = plugin;
            }
        ...
        private class EconomicsPaymentProvider : IPaymentProvider
        {
            ...
            public EconomicsPaymentProvider(NWGVending plugin)
            {
                _plugin = plugin;
            }
        ...
        private class ServerRewardsPaymentProvider : IPaymentProvider
        {
            ...
            public ServerRewardsPaymentProvider(NWGVending plugin)
            {
                _plugin = plugin;
            }
        ...
        private class NWGMarketPaymentProvider : IPaymentProvider
        {
            private NWGVending _plugin;
            private Plugin _ownerPlugin => _plugin.NWGMarket;

            public NWGMarketPaymentProvider(NWGVending plugin)
            {
                _plugin = plugin;
            }
        ...
        private class PaymentProviderResolver
        {
            ...
            public readonly NWGMarketPaymentProvider NWGMarketPaymentProvider;

            private readonly NWGVending _plugin;
            private readonly ItemsPaymentProvider _itemsPaymentProvider;
            private Configuration _config => _plugin._config;

            public PaymentProviderResolver(NWGVending plugin)
            {
                _plugin = plugin;
                ...
                NWGMarketPaymentProvider = new NWGMarketPaymentProvider(plugin);
            }
            ...
            public IPaymentProvider Resolve(VendingOffer offer, bool isForCurrency)
            {
                ...
                if (_config.NWGMarket.MatchesItem(vendingItemForPaymentProviderResolution) && NWGMarketPaymentProvider.IsAvailable)
                    return NWGMarketPaymentProvider;
...
#region Dynamic Hook Subscriptions
        ...
        private class DynamicHookSubscriber<T>
        {
            ...
            public DynamicHookSubscriber(NWGVending plugin, params string[] hookNames)
            {
                _plugin = plugin;
...
#region Vending Machine Manager
        ...
        private class VendingMachineManager
        {
            ...
            // Controllers are also cached by vending machine, in case NWGMonumentFinder is unloaded or becomes unstable.
            ...
            public VendingMachineManager(NWGVending plugin, ComponentFactory<NPCVendingMachine, VendingMachineComponent> componentFactory, PluginDataProviderRegistry dataProviderRegistry)
            {
                _plugin = plugin;
            ...
            public void HandleVendingMachineSpawned(NPCVendingMachine vendingMachine)
            {
                ...
                if (controller != null)
                {
                    // A controller may already exist if this was called when handling a reload of NWGMonumentFinder.
                    HandleExistingController(vendingMachine, controller);
                    return;
                }

                var hookResult = ExposedHooks.OnNWGVending(vendingMachine);
            ...
            private VendingController GetOrCreateController(NPCVendingMachine vendingMachine)
            {
                ...
                var dataProviderSpec = ExposedHooks.OnNWGVendingDataProvider(vendingMachine);
...
#region Edit Controller
        ...
        {
            public static void AddToContainer(NWGVending plugin, StorageContainer container, EditController editController)
            {
                var component = container.gameObject.GetComponent<EditContainerComponent>() ?? container.gameObject.AddComponent<EditContainerComponent>();
        ...
        private class EditController
        {
            ...
            public EditController(NWGVending plugin, VendingController vendingController, NPCVendingMachine vendingMachine, BasePlayer editorPlayer)
            {
                _plugin = plugin;
...
#region Vending Machine Controller
        ...
        private class VendingController
        {
            ...
            public VendingController(NWGVending plugin, ComponentFactory<NPCVendingMachine, VendingMachineComponent> componentFactory, IDataProvider dataProvider)
            {
                _plugin = plugin;
                _componentFactory = componentFactory;
...
#region Component Tracker & Factory
            ...
            where TGuest : TrackedComponent<THost, TGuest>
        {
            ...
            public ComponentFactory(NWGVending plugin, ComponentTracker<THost, TGuest> componentTracker)
            {
                _plugin = plugin;
...
#region Saved Data
        ...
        private class VendingOffer
        {
            ...
            public static VendingOffer FromItems(NWGVending plugin, BasePlayer player, Item sellItem, Item currencyItem, Item settingsItem)
            {
                ...
                if (settingsItem != null)
                {
                    ...
                    ExposedHooks.OnNWGVendingOfferSettingsParse(localizedSettings, customSettings);
        ...
        {
            private static IDataLoader<SavedPrefabRelativeData> _dataLoader = new JsonLoader<SavedPrefabRelativeData>(nameof(NWGVending));
        ...
        private class SavedMapData : BaseVendingProfileDataFile
        {
            ...
            private static string GetPerWipeFilePath() => $"{nameof(NWGVending)}/{GetPerWipeSaveName()}";
            private static string GetCrossWipeFilePath() => $"{nameof(NWGVending)}/{GetCrossWipeSaveName()}";
        ...
        {
            private static string FileName = $"{nameof(NWGVending)}_SalesData";
...
#region Configuration
        ...
        private class Configuration : SerializableConfiguration
        {
            ...
            [JsonProperty("NWG Market integration")]
            public PaymentProviderConfig NWGMarket = new();
...
#region Localization
        ...
        protected override void LoadDefaultMessages()
        {
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                [Lang.ErrorCurrentlyBeingEdited] = "<color=#d9534f>[NWG]</color> That vending machine is currently being edited by <color=#FFA500>{0}</color>.",
                [Lang.InfoDataProviderMap] = "<color=#b7d092>[NWG]</color> Data Provider: <color=#FFA500>Map ({0})</color>",
                [Lang.InfoDataProviderEntity] = "<color=#b7d092>[NWG]</color> Data Provider: <color=#b7d092>Entity ({0})</color>",
                [Lang.InfoDataProviderMonument] = "<color=#b7d092>[NWG]</color> Data Provider: <color=#b7d092>Monument ({0})</color>",
                [Lang.InfoDataProviderPlugin] = "<color=#b7d092>[NWG]</color> Data Provider: <color=#FFA500>Plugin ({0})</color>",
                [Lang.InfoDataProviderPluginUnknownName] = "<color=#b7d092>[NWG]</color> Data Provider: <color=#FFA500>Plugin</color>",
            }, this, "en");
        }
