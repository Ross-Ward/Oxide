...
{
    [Info("NWGAirfieldEvent", "New World Gaming", "1.0.0")]
    [Description("Airfield cargo plane landing event with NPCs, loot, and patrol helicopter")]
    class NWGAirfieldEvent : CovalencePlugin
    {
        public static List<Vector3> points = new List<Vector3>();
        public static NWGAirfieldEvent _instance;
        ...
        private Harmony harmony = new Harmony("NWGAirfieldEvent");

        private void OnServerInitialized()
        {
            harmony.UnpatchAll("NWGAirfieldEvent");
        ...
        public class CollisionListener : MonoBehaviour
        {
            ...
            NWGAirfieldEvent airfieldEvent => NWGAirfieldEvent._instance;
            ...
            private void OnTriggerStay(Collider collider)
            {
                ...
                Vector3 ejectPoint = NWGAirfieldEvent.points[0];

                foreach (Vector3 point in NWGAirfieldEvent.points)
