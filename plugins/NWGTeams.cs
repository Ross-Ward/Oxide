...
{
    [Info("NWGTeams", "New World Gaming", "1.0.0")]
    public class NWGTeams : RustPlugin
    {
        #region Static
        ...
        private static NWGTeams _ins;
        private const string Layer = "UI_NWGTeams";
        ...
        private string BetterChat_FormattedClanTag(IPlayer player)
        {
            ...
            return $"<color=#9fb8ad>[{team.TeamName}]</color>";
        }
        ...
        private void OnEntitySpawned(BuildingPrivlidge tc)
        {
            ...
            foreach (var memberID in team.members)
            {
                ...
                tc.authorizedPlayers.Remove(memberID);
        ...
        private void OnEntitySpawned(AutoTurret autoTurret)
        {
            ...
            foreach (var memberID in team.members)
            {
                ...
                autoTurret.authorizedPlayers.Remove(memberID);
            ...
            switch (type)
            {
                ...
                case "at":
                    foreach (var check in AutoTurrets)
                    {
                        ...
                        check.authorizedPlayers.Remove(target);

                        if (auth)
                            check.authorizedPlayers.Add(target);
        ...
        [ConsoleCommand("UI_NWGT")]
        private void ConsoleCommandUI_NWGT(ConsoleSystem.Arg arg)
        {
        ...
        [ConsoleCommand("UI_NWGTC")]
        private void ConsoleCommandUI_NWGTC(ConsoleSystem.Arg arg)
        {
            if (!arg.HasArgs())
                return;
            var player = arg.Player();
        ...
        private void ShowUIMembers(BasePlayer player, ulong selectedMate = 0)
        {
            ...
            foreach (var check in team.members.Take(8))
            {
                ...
                if (team.teamLeader != check)
                    container.Add(new CuiButton
                    {
                        ...
                        {
                            Color = "0 0 0 0",
                            Command = $"UI_NWGT chosemate {check}"
                        },
                        Text =
                        {
                            Text = "",
            ...
            if (_config.Options.AutoAuthorization.EnableTC)
            {
                ...
                container.Add(new CuiButton
                {
                    ...
                    Button =
                    {
                        ...
                        Command = $"UI_NWGT mtcaa {selectedMate}"
                    },
                    Text =
                    {
            ...
            if (_config.Options.AutoAuthorization.EnableCodelocks)
            {
                ...
                container.Add(new CuiButton
                {
                    ...
                    {
                        Color = "0.9686 0.9216 0.8824 0.2176",
                        Command = $"UI_NWGT mclaa {selectedMate}"
                    },
                    Text =
                    {
            ...
            if (_config.Options.AutoAuthorization.EnableAutoTurrets)
            {
                ...
                container.Add(new CuiButton
                {
                    ...
                    {
                        Color = "0.9686 0.9216 0.8824 0.2176",
                        Command = $"UI_NWGT mataa {selectedMate}"
                    },
                    Text =
                    {
            ...
            if (_config.Options.AutoAuthorization.EnableSS)
            {
                ...
                container.Add(new CuiButton
                {
                    ...
                    {
                        Color = "0.9686 0.9216 0.8824 0.2176",
                        Command = $"UI_NWGT mssaa {selectedMate}"
                    },
                    Text =
                    {
            ...
            container.Add(new CuiButton
            {
                ...
                Button =
                {
                    ...
                    Command = $"UI_NWGT mkick {selectedMate}"
                },
                Text =
                {
        ...
        private void ShowUISkins(BasePlayer player, int page = 0)
        {
            ...
            foreach (var check in data.Skins.Skip(28 * page).Take(28))
            {
                ...
                container.Add(new CuiButton
                {
                    ...
                    {
                        Color = "0 0 0 0.4",
                        Command = $"UI_NWGT openskins {check.Key} {page} 0"
                    },
                    Text =
                    {
        ...
        private void ShowUIChangeSkin(BasePlayer player, int id, int startPage, int page = 0)
        {
            ...
            foreach (var check in _config.Skins[id].Skip(28 * page).Take(28))
            {
                ...
                container.Add(new CuiButton
                {
                    ...
                    {
                        Color = "0 0 0 0.4",
                        Command = $"UI_NWGT chooseskin {id} {check} {startPage}"
                    },
                    Text =
                    {
            ...
            if (page > 0)
                container.Add(new CuiButton
                {
                    ...
                    {
                        Color = "0 0 0 0",
                        Command = $"UI_NWGT openskins {id} {startPage} {page - 1}"
                    },
                    Text =
                    {
                        Text = "Back",
        ...
        private void AddCategories(CuiElementContainer container, string category)
        {
            ...
            foreach (var check in Categories)
            {
                ...
                container.Add(new CuiButton
                {
                    ...
                    {
                        Color = "0 0 0 0",
                        Command = $"UI_NWGT category {check.Key}"
                    },
                    Text =
                    {
                        Text = "",
        ...
        private class Configuration
        {
            ...
            public string TeamSettingsCommand = "nteams";
            ...
            public Permissions Permissions = new Permissions
            {
                ...
                HudUsePermission = "nwgteams.hud",
                TeamVoicePermission = "nwgteams.voice",
                TeamSkinsPermission = "nwgteams.skins",
                TeamMarkerPermission = "nwgteams.marker"
            };
        ...
        private bool NormalizeLegacyPermissionsInConfig()
        {
            ...
            changed |= NormalizePermission(ref _config.Permissions.HudUsePermission);
            changed |= NormalizePermission(ref _config.Permissions.TeamVoicePermission);
            changed |= NormalizePermission(ref _config.Permissions.TeamSkinsPermission);
            changed |= NormalizePermission(ref _config.Permissions.TeamMarkerPermission);

            return changed;
        }

        private static bool NormalizePermission(ref string permissionName)
        {
            var normalized = NormalizeTeamsPermission(permissionName);
            if (string.Equals(normalized, permissionName, StringComparison.Ordinal))
                return false;
        ...
        private static string NormalizeTeamsPermission(string permissionName)
        {
            if (string.IsNullOrEmpty(permissionName))
                return permissionName;

            if (permissionName.StartsWith("nwgteams.", StringComparison.OrdinalIgnoreCase))
                return permissionName;

            if (permissionName.StartsWith("nwg.teams.", StringComparison.OrdinalIgnoreCase))
                return "nwgteams." + permissionName.Substring("nwg.teams.".Length);

            if (permissionName.StartsWith("teams.", StringComparison.OrdinalIgnoreCase))
                return "nwgteams." + permissionName.Substring("teams.".Length);
        ...
        protected override void LoadDefaultMessages()
        {
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ["UI_CHANGE"] = "Change",
                ["UI_CHOOSE"] = "Select",
                ["UI_BETTERTEAMS"] = "NWG TEAMS",
                ["UI_BETTERTEAMSDESCRIPTION"] = "This modification provided by New World Gaming allows for an enhanced team experience with advanced HUD, markers, and auto-authorization.",
                ["UI_CHANGES"] = "CHANGES:",
                ...
                ["CM_NO_TEAM"] = "You don't have team. If you want use NWG Teams menu, you must create team or join in team."
            }, this);
            ...
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                ["UI_CHOOSE"] = "Выбрать",
                ["UI_BETTERTEAMS"] = "NWG TEAMS",
                ["UI_BETTERTEAMSDESCRIPTION"] = "Эта модификация от New World Gaming позволяет улучшить командный опыт с помощью продвинутого HUD, маркеров и авто-авторизации.",
                ...
                ["CM_NO_TEAM"] = "У вас нет команды. Если вы хотите использовать NWG Teams создайте или вступите в команду"
            }, this, "ru");
        }
