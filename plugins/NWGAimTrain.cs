...
using VLB;
using ATUI = Oxide.Plugins.NWGAimTrainUI.UIMethods;
using UIAnchor = Oxide.Plugins.NWGAimTrainUI.UIAnchor;

namespace Oxide.Plugins
{
    [Info("NWGAimTrain", "New World Gaming", "1.0.0")]
    [Description("Aim training arena with target bots, stats, and leaderboard")]
    public class NWGAimTrain : RustPlugin
    {
        #region Declaration
        ...
        private static NWGAimTrain _instance;
        ...
        private void Init()
        {
            ...
            permission.RegisterPermission( "nwgaimtrain.join", this );
            permission.RegisterPermission( "nwgaimtrain.admin", this );
            if( _config.ArenaPermission )
            {
                foreach( string arena in _arenasCache.Keys )
                {
                    permission.RegisterPermission( $"nwgaimtrain.{arena}", this );
                        Puts( "Added extra permission: " + $"nwgaimtrain.{arena}" );
                }
            }
        ...
        {
            if( (!permission.UserHasPermission( player.UserIDString, "nwgaimtrain.join" ) && !permission.UserHasPermission( player.UserIDString, "nwg.aimtrain.join" )) || !_config.EnableAimTrain )
            {
                return;
            }
            ...
            if( _arenasCache.Keys.Count == 1 )
            {
                ...
                if( !_arenasCache[arena].SpawnsPlayer.Count.Equals( 0 ) && !_arenasCache[arena].SpawnsBot.Count.Equals( 0 ) )
                {
                    if( _config.ArenaPermission )
                    {
                        if( permission.UserHasPermission( player.UserIDString, "nwgaimtrain." + arena ) || permission.UserHasPermission( player.UserIDString, "nwg.aimtrain." + arena ) )
                        {
            ...
            if( _arenasCache.ContainsKey( arenaName ) && _arenasCache[arenaName].SpawnsBot.Count != 0 && _arenasCache[arenaName].SpawnsPlayer.Count != 0 )
            {
                if( _config.ArenaPermission )
                {
                    if( permission.UserHasPermission( player.UserIDString, "nwgaimtrain." + arenaName ) || permission.UserHasPermission( player.UserIDString, "nwg.aimtrain." + arenaName ) )
                    {
        ...
        {
            if( (!permission.UserHasPermission( player.UserIDString, "nwgaimtrain.admin" ) && !permission.UserHasPermission( player.UserIDString, "nwg.aimtrain.admin" )) || args.Length < 1 || args[0] == null )
            {
                return;
            }
        ...
        {
            if( !permission.UserHasPermission( player.UserIDString, "nwgaimtrain.admin" ) && !permission.UserHasPermission( player.UserIDString, "nwg.aimtrain.admin" ) )
            {
                return;
            }
            ...
            switch( args[0] )
            {
                case "add":
                {
                    ...
                    if( _config.ArenaPermission )
                    {
                        permission.RegisterPermission( $"nwgaimtrain.{arenaName}", this );
                    }
        ...
        private void NewBorder( UIAnchor min, UIAnchor max )
        {
            ATUI.Border( min, max, ref _cachedContainer, 0.001f, "1 1 1 1", _mainContainer );
        }
        ...
        private CuiElementContainer DrawTimer( BasePlayer player )
        {
            ...
            var container = ATUI.Container( _statsContainer, "0 0 0 0", new UIAnchor( 0f, 0.35f ), new UIAnchor( 0.1f, 0.6f ), "Hud.Menu" );
            ATUI.Text( "", _statsContainer, ref container, TextAnchor.MiddleRight, "0 0 0 1", 13, _playersCache[player.userID].Headshots.ToString() + " ", new UIAnchor( 0f, 0.8f ), new UIAnchor( 0.99f, 0.9f ) );
            ATUI.Text( "", _statsContainer, ref container, TextAnchor.MiddleRight, "0 0 0 1", 13, _playersCache[player.userID].Bullets.ToString() + " ", new UIAnchor( 0f, 0.7f ), new UIAnchor( 0.99f, 0.8f ) );
            ATUI.Text( "", _statsContainer, ref container, TextAnchor.MiddleRight, "0 0 0 1", 13, _playersCache[player.userID].Hits.ToString() + " ", new UIAnchor( 0f, 0.6f ), new UIAnchor( 0.99f, 0.7f ) );
            ATUI.Text( "", _statsContainer, ref container, TextAnchor.MiddleRight, "0 0 0 1", 13, percentComplete.ToString() + "%" + " ", new UIAnchor( 0f, 0.5f ), new UIAnchor( 0.99f, 0.6f ) );
            ATUI.Text( "", _statsContainer, ref container, TextAnchor.MiddleLeft, "0 0 0 1", 13, "  " + AmmoStatus( player.userID ), new UIAnchor( 0f, 0.4f ), new UIAnchor( 0.99f, 0.5f ) );
            return container;
        }

        private void ConstructUi()
        {
            _cachedContainer = ATUI.Container( _mainContainer, "0 0 0 0", new UIAnchor( 0f, 0.35f ), new UIAnchor( 0.1f, 0.6f ), "Overlay" );
            ATUI.Text( "Main.Name", _mainContainer, ref _cachedContainer, TextAnchor.MiddleCenter, "0 0 0 1", 15, "AimTrain", new UIAnchor( 0f, 0.9f ), new UIAnchor( 1f, 1f ) );
            ATUI.Text( "", _mainContainer, ref _cachedContainer, TextAnchor.MiddleLeft, "0 0 0 1", 13, "  Headshots: ", new UIAnchor( 0f, 0.8f ), new UIAnchor( 0.99f, 0.9f ) );
            ATUI.Text( "", _mainContainer, ref _cachedContainer, TextAnchor.MiddleLeft, "0 0 0 1", 13, "  Bullets fired: ", new UIAnchor( 0f, 0.7f ), new UIAnchor( 0.99f, 0.8f ) );
            ATUI.Text( "", _mainContainer, ref _cachedContainer, TextAnchor.MiddleLeft, "0 0 0 1", 13, "  Hits: ", new UIAnchor( 0f, 0.6f ), new UIAnchor( 0.99f, 0.7f ) );
            ATUI.Text( "", _mainContainer, ref _cachedContainer, TextAnchor.MiddleLeft, "0 0 0 1", 13, "  Accuracy: ", new UIAnchor( 0f, 0.5f ), new UIAnchor( 0.99f, 0.6f ) );
            ATUI.Button( "Button.Reset", _mainContainer, ref _cachedContainer, new UIAnchor( 0f, 0.27f ), new UIAnchor( 0.99f, 0.4f ), $"global.ResetAT", "Reset", "0 0 0", 12, "0 0 0 0" );
            ATUI.Button( "Button.Ammo", _mainContainer, ref _cachedContainer, new UIAnchor( 0f, 0.14f ), new UIAnchor( 0.99f, 0.27f ), $"global.AmmoAT", "Toggle Ammo", "0 0 0", 12, "0 0 0 0" );
            ATUI.Button( "Button.Leave", _mainContainer, ref _cachedContainer, new UIAnchor( 0f, 0f ), new UIAnchor( 0.99f, 0.14f ), $"global.LeaveAT", "Leave", "0 0 0", 12, "0 0 0 0" );
            NewBorder( new UIAnchor( 0f, 0.27f ), new UIAnchor( 0.99f, 0.4f ) );
            NewBorder( new UIAnchor( 0f, 0.14f ), new UIAnchor( 0.99f, 0.27f ) );
            NewBorder( new UIAnchor( 0f, 0f ), new UIAnchor( 1f, 1f ) );
            ATUI.Element( "", _mainContainer, ref _cachedContainer, new UIAnchor( 0.993f, 0f ), new UIAnchor( 0.99f, 1f ), "1 1 1 1" );
...
namespace Oxide.Plugins.NWGAimTrainUI
{
    public class UIMethods
    {
        public static CuiElementContainer Container( string name, string bgColor, UIAnchor Min, UIAnchor Max,
        ...
        public static void Panel( string name, string parent, ref CuiElementContainer container, string bgColor,
            UIAnchor Min, UIAnchor Max, bool cursor = false )
        {
        ...
        public static void Label( string name, string parent, ref CuiElementContainer container, UIAnchor Min, UIAnchor Max,
        ...
        public static void Button( string name, string parent, ref CuiElementContainer container, UIAnchor Min,
            UIAnchor Max, string command, string text, string textColor,
        ...
        public static void Text( string name, string parent, ref CuiElementContainer container, TextAnchor anchor,
            ...
            UIAnchor Min, UIAnchor Max, string font = "robotocondensed-bold.ttf", float fadeOut = 0f,
            float fadeIn = 0f )
        {
        ...
        public static void Element( string name, string parent, ref CuiElementContainer container, UIAnchor Min, UIAnchor Max,
        ...
        public static void Border( UIAnchor posMin, UIAnchor posMax, ref CuiElementContainer container, float borderSize = 0.001f, string color = "1 1 1 1", string parent = "Overlay" )
        {
            Element( "", parent, ref container, posMin, new UIAnchor( posMax.X, posMin.Y + borderSize * 2 ), "1 1 1 1" );
            Element( "", parent, ref container, new UIAnchor( posMin.X, posMax.Y - borderSize * 2 ), posMax, "1 1 1 1" );
            Element( "", parent, ref container, posMin, new UIAnchor( posMin.X + borderSize, posMax.Y ), "1 1 1 1" );
            Element( "", parent, ref container, new UIAnchor( posMax.X, posMin.Y ), new UIAnchor( posMax.X + borderSize, posMax.Y ), "1 1 1 1" );
        }
    }
    ...
    public class UIAnchor
    {
        ...
        public UIAnchor( float x, float y )
        {
            X = x;
            Y = y;
        }

        public static UIAnchor operator +( UIAnchor first, UIAnchor second )
        {
            return new UIAnchor( first.X + second.X, first.Y + second.Y );
        }
